...
class TestRouting:
    ...
    def test_route_after_advance_next_page(self) -> None:
    ...
    def test_route_after_advance_done(self) -> None:
    ...
    def test_route_after_advance_single_page(self) -> None:
        state: PipelineState = {"page_index": 1, "pages": ["a"]}
        assert route_after_advance(state) == "finalize"

    def test_route_after_advance_two_pages_midway(self) -> None:
...
class TestPipelineEndToEnd:
    @pytest.mark.asyncio
    async def test_single_page_pipeline(self, tmp_path: Path) -> None:
